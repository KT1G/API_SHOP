...
router.get('/likes/filterBy/loverId/:lover_id', getLikesByLoverId)

// delete like by id
router.delete('/likes/delete/byId/:id', checkAccountSession, deleteLikeById)

// delete like by product id
router.delete('/likes/delete/byProductId/:product_id', checkAccountSession, deleteLikeByProductId)
